...
import 'package:risk_surveyor_app/screens/svy/survey_int_rust.dart';
...
class SurveyIntFootCarpet extends StatefulWidget {
  const SurveyIntFootCarpet({Key? key}) : super(key: key);
  ...
  @override
  State<SurveyIntFootCarpet> createState() => _SurveyIntFootCarpetState();
}

class _SurveyIntFootCarpetState extends State<SurveyIntFootCarpet> {
  ...
  Future<void> GetData() async {
    ...
    for (File element in filelist) {
      if (element.toString().contains("_int_foot_carpet_")) {
  ...
  void selectImages() async {
    ...
    selectedImages.forEach((selectedImage) async {
      if (await Util().isImageAllowed(selectedImage)) {
        ...
        final String fileName = '${data['QuotationNo']}_int_foot_carpet_${imageFileList?.length}.jpg';
                  ...
                  child: Card(
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          title: Text(
                            "Karpet Kaki (Cek bagian dibawah jok, pintu bagian dalam dekat engsel yang seringnya tertutup disela-sela baut dan bawah apakah ada kotoran. Korosi dan karat yang banyak dan tidak umum)",
                            style: TextStyle(
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          name: 'Bagian Bawah Jok',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Bagian Bawah Jok'],
                                          options: const [
        ...
        btn: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                next();
                //Get.to(const SurveyIntRust(), arguments: data);
              },
              heroTag: 'next',
              tooltip: 'Next',
  ...
  next() async {
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      if (imageFileList!.isNotEmpty) {
        ...
        Get.to(const SurveyIntRust(), arguments: [data, surveyResult]);
      } else {
