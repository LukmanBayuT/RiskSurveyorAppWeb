...
import 'package:risk_surveyor_app/screens/svy/survey_tw_spd.dart';
...
class SurveyTwExtLh extends StatefulWidget {
  const SurveyTwExtLh({Key? key}) : super(key: key);

  @override
  State<SurveyTwExtLh> createState() => _SurveyTwExtLhState();
}

class _SurveyTwExtLhState extends State<SurveyTwExtLh> {
        ...
        child: Column(
          children: [
            Text(
              ...
              'Berdiri di samping kiri motor sperti di gambar.'
                  '\n'
            ...
            Image.asset('assets/images/tw-lh.png', height: 35.h),
          ],
        ),
      );
    }
        ...
        btn: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Get.to(const SurveyTwExtSpd(), arguments: [data, surveyResult]);
              },
              heroTag: 'next',
              tooltip: 'Next',
