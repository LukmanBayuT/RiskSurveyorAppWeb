...
import 'package:risk_surveyor_app/screens/svy/survey_ext_rr.dart';
...
class SurveyExtRh extends StatefulWidget {
  const SurveyExtRh({Key? key}) : super(key: key);
  ...
  @override
  State<SurveyExtRh> createState() => _SurveyExtRhState();
}

class _SurveyExtRhState extends State<SurveyExtRh> {
  ...
  Future<void> GetData() async {
    ...
    for (File element in filelist) {
      if (element.toString().contains("_ext_rh_")) {
  ...
  void selectImages() async {
    ...
    selectedImages.forEach((selectedImage) async {
      if (await Util().isImageAllowed(selectedImage)) {
        ...
        final String fileName = '${data['QuotationNo']}_ext_rh_${imageFileList?.length}.jpg';
      ...
      return Center(
        child: Column(
          children: [
            ...
            Image.asset('assets/images/rh.png', height: 15.h),
          ],
        ),
      );
    }
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          initialValue: surveyResult.checklist!['Fender Depan Kanan'],
                                          options: const [
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Pintu Depan Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          autovalidateMode: AutovalidateMode.onUserInteraction,
                                          name: 'Lantai Kendaraan Kanan',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Lantai Kendaraan Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Pintu Belakang Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          name: 'Pilar Kanan',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Pilar Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Fender Belakang Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Velg Depan Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Velg Belakang Kanan'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
  ...
  next() async {
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      if (imageFileList!.isNotEmpty) {
        ...
        Get.to(const SurveyExtRr(), arguments: [data, surveyResult]);
      } else {
