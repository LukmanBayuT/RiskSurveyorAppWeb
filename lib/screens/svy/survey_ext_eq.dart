...
import 'package:risk_surveyor_app/screens/svy/survey_int_section.dart';
...
class SurveyExtEq extends StatefulWidget {
  const SurveyExtEq({Key? key}) : super(key: key);
  ...
  @override
  State<SurveyExtEq> createState() => _SurveyExtEqState();
}

class _SurveyExtEqState extends State<SurveyExtEq> {
  ...
  Future<void> GetData() async {
    ...
    for (File element in filelist) {
      if (element.toString().contains("_ext_eq_")) {
  ...
  void selectImages() async {
    ...
    selectedImages.forEach((selectedImage) async {
      if (await Util().isImageAllowed(selectedImage)) {
        ...
        final String fileName = '${data['QuotationNo']}_ext_eq_${imageFileList?.length}.jpg';
                  ...
                  child: Card(
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          title: Text(
                            "Equipment Non-Standard Exterior Mobil",
                            style: TextStyle(
        ...
        btn: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                next();
                //Get.to(const SurveyIntSec(), arguments: data);
              },
              heroTag: 'next',
              tooltip: 'Next',
  ...
  next() async {
    ...
    Get.to(const SurveyIntSec(), arguments: [data, surveyResult]);
    // } else {
