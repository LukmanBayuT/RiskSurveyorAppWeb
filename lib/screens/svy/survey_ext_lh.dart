...
import 'package:risk_surveyor_app/screens/svy/survey_ext_top.dart';
...
class SurveyExtLh extends StatefulWidget {
  const SurveyExtLh({Key? key}) : super(key: key);
  ...
  @override
  State<SurveyExtLh> createState() => _SurveyExtLhState();
}

class _SurveyExtLhState extends State<SurveyExtLh> {
  ...
  Future<void> GetData() async {
    ...
    for (File element in filelist) {
      if (element.toString().contains("_ext_lh_")) {
  ...
  void selectImages() async {
    ...
    selectedImages.forEach((selectedImage) async {
      if (await Util().isImageAllowed(selectedImage)) {
        ...
        final String fileName = '${data['QuotationNo']}_ext_lh_${imageFileList?.length}.jpg';
      ...
      return Center(
        child: Column(
          children: [
            ...
            Image.asset('assets/images/lh.png', height: 15.h),
          ],
        ),
      );
    }
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          initialValue: surveyResult.checklist!['Fender Depan Kiri'],
                                          options: const [
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Pintu Depan Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          autovalidateMode: AutovalidateMode.onUserInteraction,
                                          name: 'Lantai Kendaraan Kiri',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Lantai Kendaraan Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Pintu Belakang Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          name: 'Pilar Kiri',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Pilar Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          ...
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Fender Belakang Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          autovalidateMode: AutovalidateMode.onUserInteraction,
                                          name: 'Velg Depan Kiri',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Velg Depan Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
                                  ...
                                  child: Column(
                                    children: [
                                      ListTile(
                                        ...
                                        subtitle: FormBuilderCheckboxGroup<dynamic>(
                                          autovalidateMode: AutovalidateMode.onUserInteraction,
                                          name: 'Velg Belakang Kiri',
                                          activeColor: AppColors.oonaPurple,
                                          initialValue: surveyResult.checklist!['Velg Belakang Kiri'],
                                          options: const [
                                            FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                            FormBuilderFieldOption(value: 'Baret atau lecet'),
                                            FormBuilderFieldOption(value: 'Penyok'),
        ...
        btn: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                next();
                //Get.to(const SurveyExtTop(), arguments: data);
              },
              heroTag: 'next',
              tooltip: 'Next',
  ...
  next() async {
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      if (imageFileList!.isNotEmpty) {
        ...
        Get.to(const SurveyExtTop(), arguments: [data, surveyResult]);
      } else {
