...
import 'package:risk_surveyor_app/screens/svy/survey_ext_rh.dart';
...
class SurveyExtFr extends StatefulWidget {
  const SurveyExtFr({Key? key}) : super(key: key);

  @override
  State<SurveyExtFr> createState() => _SurveyExtFrState();
}

class _SurveyExtFrState extends State<SurveyExtFr> {
  ...
  Future<void> GetData() async {
    ...
    for (File element in filelist) {
      if (element.toString().contains("_ext_fr_")) {
  ...
  void selectImages() async {
    ...
    selectedImages.forEach((selectedImage) async {
      if (await Util().isImageAllowed(selectedImage)) {
        ...
        final String fileName = '${data['QuotationNo']}_ext_fr_${imageFileList?.length}.jpg';
      ...
      return Center(
        child: Column(
          children: [
            ...
            Image.asset('assets/images/fr.png', height: 15.h),
          ],
        ),
      );
    }
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: FormBuilderCheckboxGroup<dynamic>(
                                              ...
                                              initialValue: surveyResult.checklist!['Kap Mesin'],
                                              options: const [
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: FormBuilderCheckboxGroup<dynamic>(
                                              ...
                                              name: 'Grill',
                                              activeColor: AppColors.oonaPurple,
                                              initialValue: surveyResult.checklist!['Grill'],
                                              options: const [
                                                FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                                FormBuilderFieldOption(value: 'Baret atau lecet'),
                                                FormBuilderFieldOption(value: 'Penyok'),
                                        ...
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: FormBuilderCheckboxGroup<dynamic>(
                                              ...
                                              name: 'Bumper depan',
                                              activeColor: AppColors.oonaPurple,
                                              initialValue: surveyResult.checklist!['Bumper depan'],
                                              options: const [
                                                FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                                FormBuilderFieldOption(value: 'Baret atau lecet'),
                                                FormBuilderFieldOption(value: 'Penyok'),
                                      ...
                                      child: Column(
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: FormBuilderCheckboxGroup<dynamic>(
                                              autovalidateMode: AutovalidateMode.onUserInteraction,
                                              name: 'Lampu depan kanan',
                                              activeColor: AppColors.oonaPurple,
                                              initialValue: surveyResult.checklist!['Lampu depan kanan'],
                                              options: const [
                                                FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                      ...
                                      child: Column(
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: FormBuilderCheckboxGroup<dynamic>(
                                              autovalidateMode: AutovalidateMode.onUserInteraction,
                                              name: 'Lampu depan kiri',
                                              activeColor: AppColors.oonaPurple,
                                              initialValue: surveyResult.checklist!['Lampu depan kiri'],
                                              options: const [
                                                FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                                FormBuilderFieldOption(value: 'Warna kusam'),
                                                FormBuilderFieldOption(value: 'Berembun'),
                                      ...
                                      child: Column(
                                        children: [
                                          ListTile(
                                            ...
                                            subtitle: FormBuilderCheckboxGroup<dynamic>(
                                              autovalidateMode: AutovalidateMode.onUserInteraction,
                                              name: 'Lampu kabut depan',
                                              activeColor: AppColors.oonaPurple,
                                              initialValue: surveyResult.checklist!['Lampu kabut depan'],
                                              options: const [
                                                FormBuilderFieldOption(value: 'Tidak ada kerusakan'),
                                                FormBuilderFieldOption(value: 'Warna kusam'),
                                                FormBuilderFieldOption(value: 'Berembun'),
  ...
  next() async {
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      if (imageFileList!.isNotEmpty) {
        ...
        Get.to(const SurveyExtRh(), arguments: [data, surveyResult]);
      } else {
