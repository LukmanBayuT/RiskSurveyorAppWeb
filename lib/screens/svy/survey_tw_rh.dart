...
import 'package:risk_surveyor_app/screens/svy/survey_tw_rr.dart';
...
class SurveyTwExtRh extends StatefulWidget {
  const SurveyTwExtRh({Key? key}) : super(key: key);

  @override
  State<SurveyTwExtRh> createState() => _SurveyTwExtRhState();
}

class _SurveyTwExtRhState extends State<SurveyTwExtRh> {
        ...
        child: Column(
          children: [
            Text(
              ...
              'Berdiri di samping kanan motor sperti di gambar.'
                  '\n'
            ...
            Image.asset('assets/images/tw-rh.png', height: 35.h),
          ],
        ),
      );
    }
        ...
        btn: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Get.to(const SurveyTwExtRr(), arguments: [data, surveyResult]);
              },
              heroTag: 'next',
              tooltip: 'Next',
