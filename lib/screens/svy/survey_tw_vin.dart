...
class SurveyTwExtVin extends StatefulWidget {
  const SurveyTwExtVin({Key? key}) : super(key: key);

  @override
  State<SurveyTwExtVin> createState() => _SurveyTwExtVinState();
}

class _SurveyTwExtVinState extends State<SurveyTwExtVin> {
  ...
  Future<void> GetData() async {
    ...
    for (File element in filelist) {
      if (element.toString().contains("_ext_vin_")) {
