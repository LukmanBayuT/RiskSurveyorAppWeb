...
import 'package:risk_surveyor_app/screens/svy/survey_tw_rh.dart';
...
class SurveyTwExtFr extends StatefulWidget {
  const SurveyTwExtFr({Key? key}) : super(key: key);

  @override
  State<SurveyTwExtFr> createState() => _SurveyTwExtFrState();
}

class _SurveyTwExtFrState extends State<SurveyTwExtFr> {
      ...
      return Center(
        child: Column(
          children: [
            ...
            Image.asset('assets/images/tw-fr.png', height: 35.h),
          ],
        ),
      );
    }
        ...
        btn: [
          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Get.to(const SurveyTwExtRh(), arguments: [data, surveyResult]);
              },
              heroTag: 'next',
              tooltip: 'Next',
